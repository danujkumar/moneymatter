...
export const eduFees = <i className="fa-solid fa-building-columns"></i>;
export const electric = <i className="fa-solid fa-plug"></i>;
export const homeRent = <i class="fa-solid fa-apartment"></i>;
